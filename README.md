...
manages routing, sessions, HTTP requests, error handling,
Express. js helps the programmers to build efficient and fast web apps.

1. Understand and explain the use of Middleware.

have access to the request object ( req ), the response object ( res ), and the next function in the application
